...
import Slider1 from "../../image/b1.png";
import Slider2 from "../../image/b2.png";
import Slider3 from "../../image/b3.png";
import Slider4 from "../../image/b4.png";


const BussinessclassName = () => {
    var settings = {
        dots: false,
        arrows: true,
        infinite: true,
  ...
  return (
    ...
    <div className="container">
        <h2 className="title left">Business  <span>Class</span></h2>
        <ul className="">
        <Slider {...settings}>
        <li>
...
export default BussinessclassName;
